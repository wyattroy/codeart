...
// Dot variables
const diameterAdj = 0.9; // Set at 1 to have the dots touch
const backgroundColor = 0;
const backgroundFader = 8; // how long the trails will be

// How often to change the image
const captureInterval = 8 * 1000; // 8 seconds total
let lastCaptureTime = 0;

// Transition varialbes
let transitionPixels = [];
let transitionStartTime = 0;
const duration = captureInterval;

const tolerance = 80; // Pixel color similarity
const initialDelay = 200; // 200ms delay for the second frame

// Jitter settings
const durationJitter = 1000; // Each pixel can start up to 500ms late
...
// Allow user to lower or increase dot resolution to match their system's capabilities
// by pressing number keys
function keyPressed() {
